...
//           )}
//         </div>
//         <Input label="Available Stock" value={availableStock} readOnly disabled />
//         <Input label="Qty *" type="number" min="1" value={qty} onChange={(e) => setQty(e.target.value)} />
//       </div>
//       <div className="form-row-3" style={{ marginTop: 14 }}>
//         <Input
//           label="Purchase Price *" type="number" min="0" step="0.01"
//           value={price} onChange={(e) => handlePriceChange(e.target.value)}
//           hint="Also updates Item Cost below (unless you've edited it separately)"
//         />
//         <Input label="MRP" value={selected?.mrp ?? ''} readOnly disabled />
//         <Input label="GST %" type="number" min="0" value={gst} onChange={(e) => setGst(e.target.value)} />
//       </div>
//       <div className="form-row-3" style={{ marginTop: 14 }}>
//         <Input
//           label="Item Cost" type="number" min="0" step="0.01"
//           value={itemCost} onChange={(e) => handleItemCostChange(e.target.value)}
//           {...itemCostExtras()}
//         />
//         <Input
//           label="Distributor Price" type="number" min="0" step="0.01"
//           value={distributorPrice} onChange={(e) => setDistributorPrice(e.target.value)}
//           {...priceFieldExtras('distributorPrice', distributorPrice, setDistributorPrice)}
//         />
//         <Input
//           label="Retailer Price" type="number" min="0" step="0.01"
//           value={retailerPrice} onChange={(e) => setRetailerPrice(e.target.value)}
//           {...priceFieldExtras('retailerPrice', retailerPrice, setRetailerPrice)}
//         />
//       </div>
//       <div className="form-row-3" style={{ marginTop: 14 }}>
//         <Input
//           label="Walk-in Price" type="number" min="0" step="0.01"
